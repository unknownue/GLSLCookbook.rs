...
impl Scene for SceneTexture {

    fn new(display: &impl Facade) -> GLResult<SceneTexture> {

        // Shader Program ------------------------------------------------------------
        let program = SceneTexture::compile_shader_program(display)
        ...
        // Initialize Textures --------------------------------------------------------
        let texture = load_texture(display, "media/texture/brick1.png")?;
        // ----------------------------------------------------------------------------
