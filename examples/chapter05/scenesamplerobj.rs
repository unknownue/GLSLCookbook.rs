...
use cookbook::texture::load_custom_texture;
...
impl Scene for SceneSamplerObj {
    ...
    fn new(display: &impl Facade) -> GLResult<SceneSamplerObj> {
        ...
        let checkerboard_tex = load_custom_texture(display, checkerboard, W, H,  MipmapsOption::AutoGeneratedMipmaps, UncompressedFloatFormat::U8U8U8U8)?;
        // ----------------------------------------------------------------------------
