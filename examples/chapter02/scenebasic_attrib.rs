...
impl Scene for SceneBasicAttrib {
    ...
    fn new(display: &impl Facade, scene_data: SceneData) -> GLResult<SceneBasicAttrib> {
...
impl SceneBasicAttrib {
    ...
    fn compile_shader_program(display: &impl Facade) -> Result<Program, ProgramCreationError> {
        ...
        // Note that glium does not provide the same flexibility in customizing vertex attributes.
        // This should not be a problem, since current implementation is a good pattern in using vertex attributes.
